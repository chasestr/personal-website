...
const Introduction = () => {
    ...
    return (
        <div className={styles.container}>
            <Image src="/me.jpeg" alt="Picture of me" width={100} height={100} className={styles.image__mobile} unoptimized/>
            <div>
                <div className={styles.title}>
                Hi, I'm <span id="name" className={styles.name}>Chase</span>
                </div>
            ...
            <Image src="/me.jpeg" alt="Picture of me" width={100} height={100} className={styles.image__desktop} unoptimized/>
        </div>
    );
}
